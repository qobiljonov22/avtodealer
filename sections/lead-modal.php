...
$models = is_array($m['models'] ?? null) ? $m['models'] : [];
$close = (string) ($m['close_label'] ?? '');
?>
<div
    id="avto-lead-modal"
    ...
    <button type="button" class="absolute inset-0 bg-black/70 backdrop-blur-[2px]" data-lead-close tabindex="-1" aria-label="<?php echo esc_attr($close); ?>"></button>
    ...
    <div class="relative z-[1] w-full max-w-[360px] rounded-2xl border border-white/10 bg-[#1A1A1A] p-5 shadow-[0_30px_80px_rgba(0,0,0,0.55)] sm:max-w-[420px] sm:p-6 md:max-w-[480px] md:p-7 lg:max-w-[520px] lg:p-8 xl:max-w-[560px] 2xl:max-w-[600px] 3xl:max-w-[640px]">
        ...
        <form class="mt-5 space-y-3.5 sm:mt-6 sm:space-y-4" data-lead-form novalidate>
            <label class="block">
                <span class="mb-1.5 block text-[12px] text-white/55 sm:text-[13px]"><?php echo esc_html($m['model_label'] ?? ''); ?></span>
                <select
                    name="model"
                    required
                    ...
                    <option value="" disabled selected><?php echo esc_html($m['model_label'] ?? ''); ?></option>
            ...
            <label class="block">
                <span class="mb-1.5 block text-[12px] text-white/55 sm:text-[13px]"><?php echo esc_html($m['phone_label'] ?? ''); ?></span>
                <input
                    type="tel"
                    name="phone"
                    required
                    autocomplete="tel"
                    inputmode="tel"
                    placeholder="<?php echo esc_attr($m['phone_placeholder'] ?? ''); ?>"
